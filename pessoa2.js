//Quando trabalhamos com objetos, podemos inserir qualquer tipo de daodo: texto, um numero, um booleano, uma lista(array), uma função, outros objetos, pois, são todos tipos de variaveis
...
// adicionando uma lista(array) no nosso objetos 

pessoa2.interesses =['Carros', 'Astrologia', 'Futebol', 'Javascript'];

console.log(pessoa2);
console.log(pessoa2.interesses.length); // conta qnts tem
console.log(pessoa2.interesses[3]); //para mostrar o conteudo de determinada posição
